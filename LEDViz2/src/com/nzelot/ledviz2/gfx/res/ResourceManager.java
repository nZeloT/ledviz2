 ...
 * The Resource Loader is implementing the Singleton Pattern.<br>
 * @author Leon
 *
 */
public class ResourceManager {
	...
	/**
	 * Stores all resources to their fileName
	 */
	private HashMap<String, Resource>  resources;

	/**
	 * Defines which Resource to load with which ResourceLoader
	 */
	private HashMap<String, IResourceLoader> loader;


	/**
	 * Method to get a loaded Resource
	 * @param name the Name of the Resource. To be more concrete, the filename
	 ...
	 * @param l
	 */
	public static void addLoader(String extension, IResourceLoader l){
		init();
	 ...
	 * @return
	 */
	public static IResourceLoader removeLoader(String extension){
		init();
	...
	/**
	 * Load all resources using the resources loaders
	 */
	...
	private ResourceManager(){
		...
		loader = new HashMap<String, IResourceLoader>();
	}


	/**
	 * A method to initialize the instance field of the class
	 */
