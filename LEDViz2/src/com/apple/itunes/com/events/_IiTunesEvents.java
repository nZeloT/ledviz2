package com.apple.itunes.com.events;
...
public abstract class _IiTunesEvents {
   ...
   * </p>
   * @param reason Mandatory com.apple.itunes.com.ITCOMDisabledReason parameter.
   */

  @DISPID(6)
  public void onCOMCallsDisabledEvent(
    com.apple.itunes.com.ITCOMDisabledReason reason) {
        throw new UnsupportedOperationException();
  }
