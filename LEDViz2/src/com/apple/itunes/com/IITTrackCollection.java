...
public interface IITTrackCollection extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(8)
  @DefaultMethod
  com.apple.itunes.com.IITTrack item(
    int index);
  ...
  @VTID(9)
  com.apple.itunes.com.IITTrack itemByPlayOrder(
    int index);
  ...
  @VTID(10)
  com.apple.itunes.com.IITTrack itemByName(
  ...
  @VTID(12)
  com.apple.itunes.com.IITTrack itemByPersistentID(
    int highID,
    int lowID);
