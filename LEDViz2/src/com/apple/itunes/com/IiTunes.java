...
public interface IiTunes extends Com4jObject {
   ...
   * </p>
   * @param filePath Mandatory java.lang.String parameter.
   * @return  Returns a value of type com.apple.itunes.com.IITOperationStatus
   */

  @DISPID(1610743819) //= 0x6002000b. The runtime will prefer the VTID if present
  @VTID(18)
  com.apple.itunes.com.IITOperationStatus convertFile(
    java.lang.String filePath);
  ...
  @VTID(19)
  com.apple.itunes.com.IITOperationStatus convertFiles(
  ...
  @VTID(20)
  com.apple.itunes.com.IITOperationStatus convertTrack(
  ...
  @VTID(21)
  com.apple.itunes.com.IITOperationStatus convertTracks(
   ...
   * @return  Returns a value of type com.apple.itunes.com.IITObject
   */

  @DISPID(1610743824) //= 0x60020010. The runtime will prefer the VTID if present
  @VTID(23)
  com.apple.itunes.com.IITObject getITObjectByID(
    int sourceID,
    int playlistID,
    int trackID,
    int databaseID);
  ...
  @VTID(24)
  com.apple.itunes.com.IITPlaylist createPlaylist(
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITSourceCollection
   */

  @DISPID(1610743831) //= 0x60020017. The runtime will prefer the VTID if present
  @VTID(30)
  com.apple.itunes.com.IITSourceCollection sources();


  @VTID(30)
  @ReturnValue(defaultPropertyThrough={com.apple.itunes.com.IITSourceCollection.class})
  com.apple.itunes.com.IITSource sources(
    int index);
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITEncoderCollection
   */

  @DISPID(1610743832) //= 0x60020018. The runtime will prefer the VTID if present
  @VTID(31)
  com.apple.itunes.com.IITEncoderCollection encoders();


  @VTID(31)
  @ReturnValue(defaultPropertyThrough={com.apple.itunes.com.IITEncoderCollection.class})
  com.apple.itunes.com.IITEncoder encoders(
    int index);
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITEQPresetCollection
   */

  @DISPID(1610743833) //= 0x60020019. The runtime will prefer the VTID if present
  @VTID(32)
  com.apple.itunes.com.IITEQPresetCollection eqPresets();


  @VTID(32)
  @ReturnValue(defaultPropertyThrough={com.apple.itunes.com.IITEQPresetCollection.class})
  com.apple.itunes.com.IITEQPreset eqPresets(
    int index);
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITVisualCollection
   */

  @DISPID(1610743834) //= 0x6002001a. The runtime will prefer the VTID if present
  @VTID(33)
  com.apple.itunes.com.IITVisualCollection visuals();


  @VTID(33)
  @ReturnValue(defaultPropertyThrough={com.apple.itunes.com.IITVisualCollection.class})
  com.apple.itunes.com.IITVisual visuals(
    int index);
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITWindowCollection
   */

  @DISPID(1610743835) //= 0x6002001b. The runtime will prefer the VTID if present
  @VTID(34)
  com.apple.itunes.com.IITWindowCollection windows();


  @VTID(34)
  @ReturnValue(defaultPropertyThrough={com.apple.itunes.com.IITWindowCollection.class})
  com.apple.itunes.com.IITWindow windows(
    int index);
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.ITPlayerState
   */

  @DISPID(1610743840) //= 0x60020020. The runtime will prefer the VTID if present
  @VTID(39)
  com.apple.itunes.com.ITPlayerState playerState();
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITEncoder
   */

  @DISPID(1610743843) //= 0x60020023. The runtime will prefer the VTID if present
  @VTID(42)
  com.apple.itunes.com.IITEncoder currentEncoder();
   ...
   * </p>
   * @param iEncoder Mandatory com.apple.itunes.com.IITEncoder parameter.
   */

  @DISPID(1610743843) //= 0x60020023. The runtime will prefer the VTID if present
  @VTID(43)
  void currentEncoder(
    com.apple.itunes.com.IITEncoder iEncoder);
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.ITVisualSize
   */

  @DISPID(1610743849) //= 0x60020029. The runtime will prefer the VTID if present
  @VTID(48)
  com.apple.itunes.com.ITVisualSize visualSize();
   ...
   * </p>
   * @param visualSize Mandatory com.apple.itunes.com.ITVisualSize parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITVisual
   */

  @DISPID(1610743851) //= 0x6002002b. The runtime will prefer the VTID if present
  @VTID(50)
  com.apple.itunes.com.IITVisual currentVisual();
   ...
   * </p>
   * @param iVisual Mandatory com.apple.itunes.com.IITVisual parameter.
   */

  @DISPID(1610743851) //= 0x6002002b. The runtime will prefer the VTID if present
  @VTID(51)
  void currentVisual(
    com.apple.itunes.com.IITVisual iVisual);
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITEQPreset
   */

  @DISPID(1610743855) //= 0x6002002f. The runtime will prefer the VTID if present
  @VTID(54)
  com.apple.itunes.com.IITEQPreset currentEQPreset();
   ...
   * </p>
   * @param iEQPreset Mandatory com.apple.itunes.com.IITEQPreset parameter.
   */

  @DISPID(1610743855) //= 0x6002002f. The runtime will prefer the VTID if present
  @VTID(55)
  void currentEQPreset(
    com.apple.itunes.com.IITEQPreset iEQPreset);
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITBrowserWindow
   */

  @DISPID(1610743859) //= 0x60020033. The runtime will prefer the VTID if present
  @VTID(58)
  com.apple.itunes.com.IITBrowserWindow browserWindow();
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITWindow
   */

  @DISPID(1610743860) //= 0x60020034. The runtime will prefer the VTID if present
  @VTID(59)
  com.apple.itunes.com.IITWindow eqWindow();
  ...
  @VTID(60)
  com.apple.itunes.com.IITSource librarySource();
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITLibraryPlaylist
   */

  @DISPID(1610743862) //= 0x60020036. The runtime will prefer the VTID if present
  @VTID(61)
  com.apple.itunes.com.IITLibraryPlaylist libraryPlaylist();
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITTrack
   */

  @DISPID(1610743863) //= 0x60020037. The runtime will prefer the VTID if present
  @VTID(62)
  com.apple.itunes.com.IITTrack currentTrack();
  ...
  @VTID(63)
  com.apple.itunes.com.IITPlaylist currentPlaylist();
   ...
   * </p>
   * @param filePath Mandatory java.lang.String parameter.
   * @return  Returns a value of type com.apple.itunes.com.IITConvertOperationStatus
   */

  @DISPID(1610743868) //= 0x6002003c. The runtime will prefer the VTID if present
  @VTID(67)
  com.apple.itunes.com.IITConvertOperationStatus convertFile2(
    java.lang.String filePath);
  ...
  @VTID(68)
  com.apple.itunes.com.IITConvertOperationStatus convertFiles2(
    java.lang.Object filePaths);
  ...
  @VTID(69)
  com.apple.itunes.com.IITConvertOperationStatus convertTrack2(
    java.lang.Object iTrackToConvert);
  ...
  @VTID(70)
  com.apple.itunes.com.IITConvertOperationStatus convertTracks2(
    java.lang.Object iTracksToConvert);
  ...
  @VTID(75)
  com.apple.itunes.com.IITEQPreset createEQPreset(
  ...
  @VTID(76)
  com.apple.itunes.com.IITPlaylist createPlaylistInSource(
    java.lang.String playlistName,
   ...
   * @param playPauseStopState Mandatory Holder<com.apple.itunes.com.ITPlayButtonState> parameter.
  ...
  void getPlayerButtonsState(
    ...
    Holder<com.apple.itunes.com.ITPlayButtonState> playPauseStopState,
   ...
   * </p>
   * @param playerButton Mandatory com.apple.itunes.com.ITPlayerButton parameter.
  ...
  void playerButtonClicked(
    com.apple.itunes.com.ITPlayerButton playerButton,
  ...
  @VTID(81)
  com.apple.itunes.com.IITConvertOperationStatus convertOperationStatus();
  ...
  @VTID(84)
  com.apple.itunes.com.IITPlaylist createFolder(
  ...
  @VTID(85)
  com.apple.itunes.com.IITPlaylist createFolderInSource(
    java.lang.String folderName,
    java.lang.Object iSource);
