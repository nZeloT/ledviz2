...
public interface IITTrack extends com.apple.itunes.com.IITObject {
  // Methods:
  /**
   * <p>
   * Delete this track.
   ...
   * @return  Returns a value of type com.apple.itunes.com.IITArtwork
   */

  @DISPID(1610809346) //= 0x60030002. The runtime will prefer the VTID if present
  @VTID(17)
  com.apple.itunes.com.IITArtwork addArtworkFromFile(
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.ITTrackKind
   */

  @DISPID(1610809347) //= 0x60030003. The runtime will prefer the VTID if present
  @VTID(18)
  com.apple.itunes.com.ITTrackKind kind();
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITArtworkCollection
   */

  @DISPID(1610809400) //= 0x60030038. The runtime will prefer the VTID if present
  @VTID(71)
  com.apple.itunes.com.IITArtworkCollection artwork();


  @VTID(71)
  @ReturnValue(defaultPropertyThrough={com.apple.itunes.com.IITArtworkCollection.class})
  com.apple.itunes.com.IITArtwork artwork(
    int index);
