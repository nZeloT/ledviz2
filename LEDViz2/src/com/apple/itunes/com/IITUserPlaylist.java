...
public interface IITUserPlaylist extends com.apple.itunes.com.IITPlaylist {
  // Methods:
  /**
   * <p>
  ...
  @VTID(30)
  com.apple.itunes.com.IITOperationStatus addFile(
  ...
  @VTID(31)
  com.apple.itunes.com.IITOperationStatus addFiles(
   ...
   * @return  Returns a value of type com.apple.itunes.com.IITURLTrack
   */

  @DISPID(1610874882) //= 0x60040002. The runtime will prefer the VTID if present
  @VTID(32)
  com.apple.itunes.com.IITURLTrack addURL(
  ...
  @VTID(33)
  com.apple.itunes.com.IITTrack addTrack(
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.ITUserPlaylistSpecialKind
   */

  @DISPID(1610874887) //= 0x60040007. The runtime will prefer the VTID if present
  @VTID(37)
  com.apple.itunes.com.ITUserPlaylistSpecialKind specialKind();
   ...
   * </p>
   * @return  Returns a value of type com.apple.itunes.com.IITUserPlaylist
   */

  @DISPID(1610874888) //= 0x60040008. The runtime will prefer the VTID if present
  @VTID(38)
  com.apple.itunes.com.IITUserPlaylist parent();
